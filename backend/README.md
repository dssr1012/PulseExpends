...
El servidor MCP proporciona una API REST para gestionar transacciones financieras.

### Endpoints

- `GET /transactions` - Obtener todas las transacciones
- `POST /transactions` - Agregar una nueva transacción
- `GET /summary` - Obtener resumen de gastos por categoría
...
El PDF Parser es una aplicación FastAPI que extrae texto de archivos PDF y analiza transacciones financieras.
