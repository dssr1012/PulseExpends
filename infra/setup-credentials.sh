...
echo "🔐 Configuración segura de credenciales Huawei Cloud"
echo "=================================================="
...
if [ -f "${TFVARS_FILE}" ]; then
    echo "⚠️  Advertencia: ${TFVARS_FILE} ya existe"
...
# Crear terraform.tfvars con las credenciales
cat > "${TFVARS_FILE}" << EOF
...
# Configuración de instancia ECS
...
echo "✅ ${TFVARS_FILE} creado exitosamente con permisos 600"
echo ""
...
echo ""
echo "⚠️  IMPORTANTE:"
echo "   1. Este archivo NO debe committearse al repositorio"
